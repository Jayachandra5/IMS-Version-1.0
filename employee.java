...
public class employee extends parentform {
    ...
    public void attandnce(Stage stage) {
        ...
        Col2.setCellValueFactory(
                new PropertyValueFactory<EMP, String>("checkbox1"));

        TableColumn Col3 = new TableColumn("Half Pres");
        Col3.setMinWidth(80);
        Col3.setCellValueFactory(
                new PropertyValueFactory<EMP, String>("checkbox2"));
        ...
        stage.show();
            ...
            for (EMP X : attendData) {
                if (X.getCheckbox1().isSelected()) {
                    ...
                    presntCount++;
                    X.getCheckbox1().fire();
                } else if (X.getCheckbox2().isSelected()) {
                    String name = X.getFirstName();
                    attandence(name, "hp");
                    display_EmpAttendTable();
                    empAttendTable.setItems(empAttendData);
                    halfPresntCount++;
                    X.getCheckbox2().fire();
                } else if (X.getCheckbox().isSelected()) {
                    // String name = X.getFirstName();
                    //attandence(name,"a");
                    absetCount++;
                    X.getCheckbox().fire();
    ...
    public static class EMP {
        ...
        public void setSelect1(CheckBox checkbox) {
        ...
        public void setSelect2(CheckBox checkbox) {

...
public class duesTable extends parentform {
    ...
    public void totalDue(Stage stage) {
        ...
        l7 = new Label("Total Due                     :");
        l8 = new Label("");
        display_dues("totaldue");
        ...
        hb.setSpacing(15);
        hb.setPadding(new Insets(30, 30, 30, 90));
    ...
    public void display_dues(String name) {
        ...
        try ( Connection conn = this.connect_();  PreparedStatement pstmt = conn.prepareStatement(sql)) {
            ...
            if (name.equals("totaldue")) {
                double d1 = Double.parseDouble(l2.getText());
                double d2 = Double.parseDouble(l4.getText());
                ...
                if (text3 == null || text3.matches("\\s*")) {
                    ...
                    if (amount < 0) {
                        ...
                        switch (x) {
                            ...
                            case 3 -> {
                                text.setStyle("-fx-text-fill:black;");
                                text.setText("Vendor Due Cleared");
                                tf1.clear();
                                tf2.clear();
                                tf3.clear();
                            }
                ...
                if (text3 == null || text3.matches("\\s*")) {
                    ...
                    if (amount < 0) {
                        ...
                        switch (x) {
                            ...
                            case 3 -> {
                                text.setStyle("-fx-text-fill:black;");
                                text.setText("Customer Due Cleared");
                                tf1.clear();
                                tf2.clear();
                                tf3.clear();
                            }
                ...
                if (text3 == null || text3.matches("\\s*")) {
                    ...
                    if (amount < 0) {
                        ...
                        switch (x) {
                            ...
                            case 5 -> {
                                text.setStyle("-fx-text-fill:red;");
                                text.setText("Due Cant Be negative");
                            }
                            case 1 -> {
                                text.setStyle("-fx-text-fill:black;");
                                text.setText("Employee Due Updated");
